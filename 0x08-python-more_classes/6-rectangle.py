...
class Rectangle:
    """Rectangle class with int width and height properties and class property
    of number of instances and methods that return area and perimeter and str
    and repr and del method"""
